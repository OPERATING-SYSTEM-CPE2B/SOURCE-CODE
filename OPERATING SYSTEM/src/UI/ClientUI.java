...
public class ClientUI extends JFrame implements ActionListener {	
	...
	public ClientUI() {
		...
		contentPane.setBackground(new Color(208,181,41));

		panelNorth = new JPanel();
		contentPane.add(panelNorth, BorderLayout.NORTH);
		panelNorth.setLayout(new BorderLayout(0, 0));
		panelNorth.setBackground(new Color(208,181,41));

		lblChatClient = new JLabel("USTP CHAT PORTAL");
		...
		panelNorthSouth.setBackground(new Color(208,181,41));
		...
		txtAreaLogs.setBackground(new Color(21,32,43));
		...
		panelSouth.setBackground(new Color(208,181,41));
